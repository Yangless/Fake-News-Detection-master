...
if __name__ == '__main__':
    ...
    data2 = pd.read_csv("./Dataset/data/train.news.csv")
    ...
    # x_train["new"] = x_train["Title"] + ' ' + x_train["Ofiicial Account Name"]
    # x_train = x_train.drop(["Title", "Ofiicial Account Name"], axis=1)
    #
    # x_dev["new"] = x_dev["Title"] + ' ' + x_dev["Ofiicial Account Name"]
    # x_dev = x_dev.drop(["Title", "Ofiicial Account Name"], axis=1)
    #
    # x_test["new"] = x_test["Title"] + ' ' + x_test["Ofiicial Account Name"]
    # x_test = x_test.drop(["Title", "Ofiicial Account Name"], axis=1)
